...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " litecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoil-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoil transaction\n" +
            "or:     bitcoil-tx [options] -create [commands]   Create hex-encoded bitcoil transaction\n" +
            "\n";

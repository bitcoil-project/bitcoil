# Support for Output Descriptors in Bitcoil Core

Since Bitcoil Core v0.17, there is support for Output Descriptors. This is a
...
existing Bitcoil Core wallets, a convenience function `combo` is

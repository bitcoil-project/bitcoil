# Fuzzing Bitcoil Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Bitcoil Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/bitcoil-project/bitcoil
$ cd bitcoil/
$ ./autogen.sh
...
[`process_message`](https://github.com/bitcoil-project/bitcoil/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/bitcoil-project/bitcoil/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/bitcoil-project/bitcoil/tree/master/src/test/fuzz).
...
with certain assembly code from Bitcoil Core's code. See [developer notes on sanitizers](https://github.com/bitcoil-project/bitcoil/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Bitcoil Core using american fuzzy lop (`afl-fuzz`)

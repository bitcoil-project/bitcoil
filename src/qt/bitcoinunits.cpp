...
QString BitcoinUnits::longName(int unit)
{
    ...
    case mBTC: return QString("bitcs");
    case uBTC: return QString("photons");
    case SAT: return QString("bitcoshi");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Bitcoils");
    case mBTC: return QString("Bitcs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Photons (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case SAT: return QString("Bitcoshis (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
